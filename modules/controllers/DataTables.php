...
class DataTables extends MX_Controller
{
    public $columnsDefault = [
        ...
        'user_email'             => true,
        'user_is_admin'          => true,
        'user_lastlogin_datetime'      => true,
        'user_register_datetitme'             => true,
        'user_avatar'          => true,
        'user_nickname'          => true,
        'user_group'            => true,
        'Currency'         => true,
    ...
    {
        $table = ( $this->input->get('r') !== '' ) ? $this->input->get('r') : array();
        ...
        // get all raw data
        $this->load->model('backend/userModel', 'user');
        $data = json_encode($this->user->user_list(), JSON_PRETTY_PRINT);
    ...
    public function getJsonDecode($data): mixed
    {
