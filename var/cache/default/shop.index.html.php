<?php /* Tplus 1.1.3-p2 2025-09-06 02:37:32 D:\laragon\www\project\themes\default\shop.index.html 000207639 */ ?>
            ...
            <div class="d-flex flex-column flex-row-fluid">
                ...
                <div class="d-flex align-items-center pt-1">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-white fw-bold lh-1">쇼핑몰</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-4 gap-lg-10 pt-13 pb-6">
                    ...
                    <div class="page-title me-5">
                        ...
                        <h1 class="page-heading d-flex text-white fw-bold fs-2 flex-column justify-content-center my-0">
                            쇼핑몰
                            <!--begin::Description-->
                            <span class="page-desc text-gray-700 fw-semibold fs-6 pt-3">쇼핑몰 대시보드</span>
                            <!--end::Description-->
                        </h1>
                        <!--end::Title-->
                    </div>
                                ...
                                <div class="card-body d-flex flex-column justify-content-end pe-0">
                                    ...
                                    <div class="symbol-group symbol-hover flex-nowrap">
                                        ...
                                        <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                            ...
                                            <img alt="Pic" src="__media/avatars/300-11.jpg" />
                                        </div>
                                        <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                            title="Susan Redwood">
                                        ...
                                        <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                            title="Melody Macy">
                                            <img alt="Pic" src="__media/avatars/300-2.jpg" />
                                        </div>
                                        <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                            title="Perry Matthew">
                                    ...
                                    <ul class="nav nav-pills nav-pills-custom mb-3">
                                        ...
                                        <li class="nav-item mb-3 me-3 me-lg-6">
                                            ...
                                            <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden active w-80px h-85px py-4"
                                                ...
                                                <!--begin::Icon-->
                                                <div class="nav-icon">
                                                    <img alt="" src="__media/svg/products-categories/t-shirt.svg"
                                                        class="" />
                                                </div>
                                                <!--end::Icon-->
                                                <!--begin::Subtitle-->
                                        ...
                                        <li class="nav-item mb-3 me-3 me-lg-6">
                                            ...
                                            <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                                                ...
                                                <!--begin::Icon-->
                                                <div class="nav-icon">
                                                    <img alt="" src="__media/svg/products-categories/gaming.svg"
                                                        class="" />
                                                </div>
                                                <!--end::Icon-->
                                                <!--begin::Subtitle-->
                                        ...
                                        <li class="nav-item mb-3 me-3 me-lg-6">
                                            ...
                                            <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                                                ...
                                                <!--begin::Icon-->
                                                <div class="nav-icon">
                                                    <img alt="" src="__media/svg/products-categories/watch.svg"
                                                        class="" />
                                                </div>
                                                <!--end::Icon-->
                                                <!--begin::Subtitle-->
                                        ...
                                        <li class="nav-item mb-3 me-3 me-lg-6">
                                            ...
                                            <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                                                ...
                                                <!--begin::Icon-->
                                                <div class="nav-icon">
                                                    <img alt="" src="__media/svg/products-categories/gloves.svg"
                                                        class="nav-icon" />
                                                </div>
                                                <!--end::Icon-->
                                                <!--begin::Subtitle-->
                                        ...
                                        <li class="nav-item mb-3">
                                            ...
                                            <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                                                ...
                                                <!--begin::Icon-->
                                                <div class="nav-icon">
                                                    <img alt="" src="__media/svg/products-categories/shoes.svg"
                                                        class="nav-icon" />
                                                </div>
                                                <!--end::Icon-->
                                                <!--begin::Subtitle-->
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <img src="__media/stock/ecommerce/210.png"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <img src="__media/stock/ecommerce/215.png"
                                                                    class="w-50px ms-n1" alt="" />
                                                            </td>
                                                            <td class="ps-0">
                                                                <a href="../../demo34/dist/apps/ecommerce/catalog/edit-product.html"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <img src="__media/stock/ecommerce/209.png"
                                                                    class="w-50px ms-n1" alt="" />
                                                            </td>
                                                            <td class="ps-0">
                                                                <a href="../../demo34/dist/apps/ecommerce/catalog/edit-product.html"
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <img src="__media/stock/ecommerce/197.png"
                                                                    class="w-50px ms-n1" alt="" />
                                                            </td>
                                                            <td class="ps-0">
                                                                <a href="../../demo34/dist/apps/ecommerce/catalog/edit-product.html"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <img src="__media/stock/ecommerce/178.png"
                                                                    class="w-50px ms-n1" alt="" />
                                                            </td>
                                                            <td class="ps-0">
                                                                <a href="../../demo34/dist/apps/ecommerce/catalog/edit-product.html"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <img src="__media/stock/ecommerce/22.png"
                                                                    class="w-50px ms-n1" alt="" />
                                                            </td>
                                                            <td class="ps-0">
                                                                <a href="../../demo34/dist/apps/ecommerce/catalog/edit-product.html"
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <img src="__media/stock/ecommerce/1.png"
                                                                    class="w-50px ms-n1" alt="" />
                                                            </td>
                                                            <td class="ps-0">
                                                                <a href="../../demo34/dist/apps/ecommerce/catalog/edit-product.html"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <img src="__media/stock/ecommerce/24.png"
                                                                    class="w-50px ms-n1" alt="" />
                                                            </td>
                                                            <td class="ps-0">
                                                                <a href="../../demo34/dist/apps/ecommerce/catalog/edit-product.html"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <img src="__media/stock/ecommerce/71.png"
                                                                    class="w-50px ms-n1" alt="" />
                                                            </td>
                                                            <td class="ps-0">
                                                                <a href="../../demo34/dist/apps/ecommerce/catalog/edit-product.html"
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <img src="__media/stock/ecommerce/41.png"
                                                                    class="w-50px ms-n1" alt="" />
                                                            </td>
                                                            <td class="ps-0">
                                                                <a href="../../demo34/dist/apps/ecommerce/catalog/edit-product.html"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <img src="__media/stock/ecommerce/63.png"
                                                                    class="w-50px ms-n1" alt="" />
                                                            </td>
                                                            <td class="ps-0">
                                                                <a href="../../demo34/dist/apps/ecommerce/catalog/edit-product.html"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <img src="__media/stock/ecommerce/59.png"
                                                                    class="w-50px ms-n1" alt="" />
                                                            </td>
                                                            <td class="ps-0">
                                                                <a href="../../demo34/dist/apps/ecommerce/catalog/edit-product.html"
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <img src="__media/stock/ecommerce/10.png"
                                                                    class="w-50px ms-n1" alt="" />
                                                            </td>
                                                            <td class="ps-0">
                                                                <a href="../../demo34/dist/apps/ecommerce/catalog/edit-product.html"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <img src="__media/stock/ecommerce/96.png"
                                                                    class="w-50px ms-n1" alt="" />
                                                            </td>
                                                            <td class="ps-0">
                                                                <a href="../../demo34/dist/apps/ecommerce/catalog/edit-product.html"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <img src="__media/stock/ecommerce/13.png"
                                                                    class="w-50px ms-n1" alt="" />
                                                            </td>
                                                            <td class="ps-0">
                                                                <a href="../../demo34/dist/apps/ecommerce/catalog/edit-product.html"
                        ...
                        <div class="col-xl-4 mb-xl-10">
                            ...
                            <div class="card h-md-100" dir="ltr">
                                ...
                                <div class="card-body d-flex flex-column flex-center">
                                    ...
                                    <div class="mb-2">
                                        <!--begin::Title-->
                                        <h1 class="fw-semibold text-gray-800 text-center lh-lg">Have you tried <br />new
                                            <span class="fw-bolder">eCommerce App ?</span></h1>
                                        <!--end::Title-->
                                        <!--begin::Illustration-->
                                        <div class="py-10 text-center">
                                            <img src="__media/svg/illustrations/easy/2.svg"
                                                class="theme-light-show w-200px" alt="" />
                                            <img src="__media/svg/illustrations/easy/2-dark.svg"
                                    ...
                                    <div class="text-center mb-1">
                                        <!--begin::Link-->
                                        <a class="btn btn-sm btn-primary me-2" href="/backend/shopOrder/list">View
                                            App</a>
                                        <!--end::Link-->
                                        <!--begin::Link-->
                                        <a class="btn btn-sm btn-light" href="/backend/shopProduct/add">New Product</a>
                                        <!--end::Link-->
                                    </div>
                                    <!--end::Links-->
                                </div>
                                                ...
                                                <td colspan="2">
                                                    <div class="d-flex align-items-center gap-3">
                                                        <a href="#"
                                                            ...
                                                            <img src="" data-kt-src-path="__media/stock/ecommerce/"
                            ...
                            <div class="card card-flush h-xl-100">
                                ...
                                <div class="card-header pt-7">
                                    ...
                                    <h3 class="card-title align-items-start flex-column">
                                        ...
                                        <span class="text-gray-400 mt-1 fw-semibold fs-6">1M Products Shipped so
                                            far</span>
                                    </h3>
                                    <!--end::Title-->
                                    <!--begin::Toolbar-->
                                    ...
                                    <div class="hover-scroll-overlay-y pe-6 me-n6" style="height: 415px">
                                        ...
                                        <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                            ...
                                            <div class="d-flex flex-stack mb-3">
                                                ...
                                                <div class="me-3">
                                                    <!--begin::Icon-->
                                                    <img src="__media/stock/ecommerce/210.png" class="w-50px ms-n1 me-1"
                                                        alt="" />
                                                    <!--end::Icon-->
                                                    <!--begin::Title-->
                                                    <a href="../../demo34/dist/apps/ecommerce/catalog/edit-product.html"
                                        ...
                                        <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                            ...
                                            <div class="d-flex flex-stack mb-3">
                                                ...
                                                <div class="me-3">
                                                    <!--begin::Icon-->
                                                    <img src="__media/stock/ecommerce/209.png" class="w-50px ms-n1 me-1"
                                                        alt="" />
                                                    <!--end::Icon-->
                                                    <!--begin::Title-->
                                                    <a href="../../demo34/dist/apps/ecommerce/catalog/edit-product.html"
                                        ...
                                        <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                            ...
                                            <div class="d-flex flex-stack mb-3">
                                                ...
                                                <div class="me-3">
                                                    <!--begin::Icon-->
                                                    <img src="__media/stock/ecommerce/214.png" class="w-50px ms-n1 me-1"
                                                        alt="" />
                                                    <!--end::Icon-->
                                                    <!--begin::Title-->
                                                    <a href="../../demo34/dist/apps/ecommerce/catalog/edit-product.html"
                                        ...
                                        <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                            ...
                                            <div class="d-flex flex-stack mb-3">
                                                ...
                                                <div class="me-3">
                                                    <!--begin::Icon-->
                                                    <img src="__media/stock/ecommerce/211.png" class="w-50px ms-n1 me-1"
                                                        alt="" />
                                                    <!--end::Icon-->
                                                    <!--begin::Title-->
                                                    <a href="../../demo34/dist/apps/ecommerce/catalog/edit-product.html"
                                        ...
                                        <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                            ...
                                            <div class="d-flex flex-stack mb-3">
                                                ...
                                                <div class="me-3">
                                                    <!--begin::Icon-->
                                                    <img src="__media/stock/ecommerce/215.png" class="w-50px ms-n1 me-1"
                                                        alt="" />
                                                    <!--end::Icon-->
                                                    <!--begin::Title-->
                                                    <a href="../../demo34/dist/apps/ecommerce/catalog/edit-product.html"
                                        ...
                                        <div class="border border-dashed border-gray-300 rounded px-7 py-3">
                                            ...
                                            <div class="d-flex flex-stack mb-3">
                                                ...
                                                <div class="me-3">
                                                    <!--begin::Icon-->
                                                    <img src="__media/stock/ecommerce/192.png" class="w-50px ms-n1 me-1"
                                                        alt="" />
                                                    <!--end::Icon-->
                                                    <!--begin::Title-->
                                                    <a href="../../demo34/dist/apps/ecommerce/catalog/edit-product.html"
                                ...
                                <div class="card-header pt-7">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <div class="d-flex flex-stack flex-wrap gap-4">
                                            ...
                                            <!--end::Status-->
                                            <!--begin::Search-->
                                            <a href="../../demo34/dist/apps/ecommerce/catalog/products.html"
