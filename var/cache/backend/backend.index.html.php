<?php /* Tplus 1.1.3-p2 2025-09-06 02:37:30 D:\laragon\www\project\themes\backend\backend.index.html 000165560 */ ?>
                    ...
                    <div class="row g-5 g-xl-8">
                        ...
                        <div class="col-xl-8 ps-xl-12">
                            ...
                            <div class="card bgi-position-y-bottom bgi-position-x-end bgi-no-repeat bgi-size-cover min-h-250px bg-body mb-5 mb-xl-8"
                                style="background-position: 100% 50px; background-size: 500px auto; background-image: url('__media/misc/city.png')"
                                dir="ltr">
                                <!--begin::Body-->
                                            ...
                                            <div class="m-0">
                                                    ...
                                                    <div class="d-flex align-items-center me-2">
                                                        ...
                                                        <div class="symbol symbol-50px me-5">
                                                            <div class="symbol-label bg-light">
                                                                <img src="__media/svg/brand-logos/plurk.svg"
                                                                    class="h-50" alt="" />
                                                            </div>
                                                        </div>
                                                        <!--end::Symbol-->
                                                ...
                                                <div class="d-flex flex-stack mb-9">
                                                    ...
                                                    <div class="d-flex align-items-center me-2">
                                                        ...
                                                        <div class="symbol symbol-50px me-5">
                                                            <div class="symbol-label bg-light">
                                                                <img src="__media/svg/brand-logos/telegram-2.svg"
                                                                    class="h-50" alt="" />
                                                            </div>
                                                        </div>
                                                        <!--end::Symbol-->
                                                ...
                                                <div class="d-flex flex-stack">
                                                    ...
                                                    <div class="d-flex align-items-center me-2">
                                                        ...
                                                        <div class="symbol symbol-50px me-5">
                                                            <div class="symbol-label bg-light">
                                                                <img src="__media/svg/brand-logos/vimeo.svg"
                                                                    class="h-50" alt="" />
                                                            </div>
                                                        </div>
                                                        <!--end::Symbol-->
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="symbol symbol-45px me-2">
                                                                    <span class="symbol-label">
                                                                        <img src="__media/svg/brand-logos/telegram.svg"
                                                                            class="h-50 align-self-center" alt="" />
                                                                    </span>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="symbol symbol-45px me-2">
                                                                    <span class="symbol-label">
                                                                        <img src="__media/svg/brand-logos/bebo.svg"
                                                                            class="h-50 align-self-center" alt="" />
                                                                    </span>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="symbol symbol-45px me-2">
                                                                    <span class="symbol-label">
                                                                        <img src="__media/svg/brand-logos/kickstarter.svg"
                                                                            class="h-50 align-self-center" alt="" />
                                                                    </span>
                                                                </div>
                                                            </td>
                                            ...
                                            <div class="d-flex flex-column mt-10">
                                                ...
                                                <div class="d-flex">
                                                    <a href="#" class="symbol symbol-35px me-2" data-bs-toggle="tooltip"
                                                        title="Ana Stone">
                                                        <img src="__media/avatars/300-6.jpg" alt="" />
                                                    </a>
                                                    <a href="#" class="symbol symbol-35px me-2" data-bs-toggle="tooltip"
                                                        title="Mark Larson">
                                                        <img src="__media/avatars/300-5.jpg" alt="" />
                                                    </a>
                                                    <a href="#" class="symbol symbol-35px me-2" data-bs-toggle="tooltip"
                                                        title="Sam Harris">
                                                        <img src="__media/avatars/300-9.jpg" alt="" />
                                                    </a>
                                                    <a href="#" class="symbol symbol-35px" data-bs-toggle="tooltip"
                                                        title="Alice Micto">
                                                        <img src="__media/avatars/300-10.jpg" alt="" />
                                                    </a>
                                                </div>
                                            </div>
                                            <!--end:Team-->
