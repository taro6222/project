<?php /* Tplus 1.1.3-p2 2025-09-06 02:37:30 D:\laragon\www\project\themes\backend\backend.group.list.html 000114880 */ ?>
                                ...
                                <div class="card-body pt-1">
                                    ...
                                    <div class="d-flex flex-column text-gray-600">
                                        ...
                                        <div class="d-flex align-items-center py-2">
                                            ...
                                            Summaries only</div>
                                        <div class="d-flex align-items-center py-2">
                                            <span class="bullet bg-primary me-3"></span>View and Edit API
                                            Controls</div>
                                        <div class="d-flex align-items-center py-2">
                                ...
                                <div class="card-body pt-1">
                                    ...
                                    <div class="d-flex flex-column text-gray-600">
                                        ...
                                        <div class="d-flex align-items-center py-2">
                                            ...
                                            Disputes</div>
                                        <div class="d-flex align-items-center py-2">
                                            <span class="bullet bg-primary me-3"></span>Response to Customer
                                            Feedback</div>
                                    </div>
                                    <!--end::Permissions-->
                                </div>
                                ...
                                <div class="card-body pt-1">
                                    ...
                                    <div class="d-flex flex-column text-gray-600">
                                        ...
                                        <div class="d-flex align-items-center py-2">
                                            ...
                                            Summaries only</div>
                                        <div class="d-flex align-items-center py-2">
                                            <span class="bullet bg-primary me-3"></span>View Bulk Reports
                                            only</div>
                                        <div class="d-flex align-items-center py-2">
                                            <span class="bullet bg-primary me-3"></span>View Payouts only
                                        </div>
                            ...
                            <div class="card h-md-100">
                                ...
                                <div class="card-body d-flex flex-center">
                                    ...
                                    <button type="button" class="btn btn-clear d-flex flex-column flex-center"
                                        ...
                                        <!--begin::Illustration-->
                                        <img src="__media/illustrations/sketchy-1/4.png" alt=""
