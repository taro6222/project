<?php /* Tplus 1.1.3-p2 2025-09-13 13:22:10 D:\laragon\www\project\themes\backend\backend.user.list.html 000043237 */ ?>
                ...
                <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-4 gap-lg-10 pt-13 pb-6">
                    ...
                    <div class="page-title me-5">
                        ...
                        <h1 class="page-heading d-flex text-white fw-bold fs-2 flex-column justify-content-center my-0">
                            사용자
                            <!--begin::Description-->
                            <span class="page-desc text-gray-700 fw-semibold fs-6 pt-3">가입한 모든 사용자 목록</span>
                            <!--end::Description-->
                        </h1>
                        <!--end::Title-->
                    </div>
                    ...
                    <div class="card">
                                ...
                                <form>
                                    ...
                                    <div class="d-flex align-items-center position-relative my-1">
                                        ...
                                        <input type="text" name="q" value="{{SEARCH_NAME}}"
                                            ...
                                            class="form-control form-control-solid w-250px ps-13" placeholder="검색" />
                                        <div class="d-flex justify-content-end ms-3"><button type="submit"
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                    ...
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#kt_modal_add_user"><i class="ki-outline ki-plus fs-2"></i>새로운
                                        사용자</button>
                                    <!--end::Add user-->
                                </div>
                                <!--end::Toolbar-->
                                ...
                                <div class="d-flex justify-content-end align-items-center d-none"
                                    ...
                                    <div class="fw-bold me-5"><span class="me-2"
                                            data-kt-user-table-select="selected_count"></span>선택</div>
                                    <button type="button" class="btn btn-danger"
                                        data-kt-user-table-select="delete_selected">선택 삭제</button>
                                </div>
                                <!--end::Group actions-->
                                                ...
                                                <form class="form" novalidate="novalidate" id="kt_modal_add_user_form"
                                                    ...
                                                    <div class="d-flex flex-column scroll-y px-5 px-lg-10"
                                                        ...
                                                        <div class="fv-row mb-7">
                                                            <!--begin::Label-->
                                                            <label class="d-block fw-semibold fs-6 mb-5">프로필 사진</label>
                                                            <!--end::Label-->
                                                            <!--begin::Image placeholder-->
                                                            <style>
                                                                .image-input-placeholder {
                                                                    background-image: url("__media/svg/files/blank-image.svg");
                                                                }

                                                                [data-bs-theme="dark"] .image-input-placeholder {
                                                                    background-image: url("__media/svg/files/blank-image-dark.svg");
                                                                }
                                                            </style>
                                                            ...
                                                            <div class="image-input image-input-outline image-input-placeholder"
                                                                ...
                                                                <div
                                                                    class="image-input-wrapper image-input-placeholder w-125px h-125px">
                                                                </div>
                                                            ...
                                                            <!--end::Image input-->
                                                            <!--begin::Hint-->
                                                            <div class="form-text">등록가능 이미지: gif, png, jpg, jpeg, webp.
                                                            </div>
                                                            <!--end::Hint-->
                                                        </div>
                                                        <!--end::Input group-->
                                                        ...
                                                        <div class="fv-row mb-7">
                                                            <!--begin::Label-->
                                                            <label class="required fw-semibold fs-6 mb-2">사용자 이름</label>
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <input type="text" name="user_name"
                                                                class="form-control form-control-solid mb-3 mb-lg-0"
                                                                placeholder="Full name" value="모냐이건" />
                                                            <!--end::Input-->
                                                        </div>
                                                        <!--end::Input group-->
                                                        <!--begin::Input group-->
                                                        ...
                                                        <div class="fv-row mb-7">
                                                            <!--begin::Label-->
                                                            <label class="required fw-semibold fs-6 mb-2">비밀번호</label>
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <input type="password" name="user_passwd"
                                                                class="form-control form-control-solid mb-3 mb-lg-0"
                                                                placeholder="" value="1111" />
                                                            <!--end::Input-->
                                                        </div>
                                                        <!--end::Input group-->
                                                        <!--begin::Input group-->
                                                        <div class="mb-5">
                                                            <!--begin::Label-->
                                                            <label class="required fw-semibold fs-6 mb-5">역할</label>
                                                            <!--end::Label-->
                                                            <!--begin::Roles-->
                                                            <!--begin::Input row-->
                                                    ...
                                                    <div class="text-center pt-10">
                                                        ...
                                                        <button type="submit" id="kt_add_user_submit"
                        ...
                        <div class="card-body py-4">
                            ...
                            <table class="table table-hover align-middle table-row-dashed fs-6 gy-5"
                                id="kt_table_users">
                                <thead>
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase bg-light gs-0">
                                        <th class="w-10px pe-2 rounded-start ps-4">
                                            <div
                                        ...
                                        <th class="min-w-125px fs-6">사용자</th>
                                        <th class="min-w-125px fs-6">그룹</th>
                                        <th class="min-w-125px fs-6">.</th>
                                        <th class="min-w-125px fs-6">최근 로그인</th>
                                        <th class="min-w-50px fs-6">가입일</th>
                                        <th class="text-end min-w-50px fs-6 pe-4 rounded-end">기능</th>
                                    </tr>
                                </thead>
                                <tbody class="text-gray-600 fw-semibold">
                                    <!--{{@LOOP_USER}}-->
                                    <tr class="h-70px">
                                        <td class="rounded-start ps-4">
                                            <div class="form-check form-check-sm form-check-custom form-check-solid">
                                                <input class="form-check-input" type="checkbox" name="user_key"
                                                    value="{{.user_key}}" />
                                            </div>
                                        </td>
                                            ...
                                            <div class="symbol symbol-circle symbol-45px overflow-hidden me-3 mt-sm-2">
                                                <a href="/backend/user/info?key={{.user_key}}">
                                                    ...
                                                    <div class="symbol-label">
                                                        <img src="{{.user_avatar_image}}" alt="Emma Smith"
                                                            class="w-100" />
                                                    </div>
                                                    <!--{{/}}-->
                                                </a>
                                        ...
                                        <td></td>
                                        <td>
                                            <div data-bs-toggle="tooltip" title="{{.user_register_datetitme}}">
                                                {{.user_register_passing}}</div>
                                        </td>
                            ...
                            <div class="separator separator-dashed my-5"></div>
                            <div class="row">
                                <div class="col-sm mt-1 d-flex flex-row">
                                    <a href="#" class="btn btn-primary btn-flex btn-center btn-sm"
                                    ...
                                    <div class="d-flex col-sm ms-5">
                                        <ol class="breadcrumb breadcrumb-dot text-muted fs-6 fw-semibold">
                                            <li class="breadcrumb-item">현재 {{CURRENT_PAGE}} 페이지</li>
                                            <li class="breadcrumb-item">표시 {{PER_PAGE}}</li>
                                            <li class="breadcrumb-item">검색 {{TOTAL_SEARCH}}</li>
                                        </ol>
                                    </div>
                                    <!--end::Menu-->
