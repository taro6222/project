<?php /* Tplus 1.1.3-p2 2025-09-06 02:37:30 D:\laragon\www\project\themes\backend\backend.shopCustomer.list.html 000189462 */ ?>
                ...
                <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-4 gap-lg-10 pt-13 pb-6">
                    ...
                    <div class="page-title me-5">
                        ...
                        <h1 class="page-heading d-flex text-white fw-bold fs-2 flex-column justify-content-center my-0">
                            고객 목록
                            <!--begin::Description-->
                            <span class="page-desc text-gray-700 fw-semibold fs-6 pt-3">쇼핑몰 구매 고객 목록</span>
                            <!--end::Description-->
                        </h1>
                        <!--end::Title-->
                    </div>
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                                ...
                                <tbody class="fw-semibold text-gray-600">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/backend/shopCustomer/info"
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="/backend/shopCustomer/info" class="menu-link px-3">View</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                        ...
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                            ...
                            <div class="modal-content">
                                ...
                                <form class="form" action="#" id="kt_modal_add_customer_form"
                                    data-kt-redirect="../../demo34/dist/apps/customers/list.html">
                                    <!--begin::Modal header-->
